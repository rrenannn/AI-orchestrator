...
4. Add a bounded sequential runner for the installed Claude Code and Codex CLIs.
...
- Uses the installed CLIs in non-interactive mode with workspace-scoped permissions.
